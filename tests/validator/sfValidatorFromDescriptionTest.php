 ...
 * @coversNothing
 */
class sfValidatorFromDescriptionTest extends TestCase
{
    ...
    public function testTodoMigrate()
    {
        ...
        foreach ($tests as $test) {
            ...
            $this->is($evaledValidator->asString(), $v->asString(), sprintf('sfValidatorFromDescription is able to parse "%s"', str_replace("\n", '\n', $test)));
            ...
            $this->is($v1->asString(), $v2->asString(), sprintf('sfValidatorFromDescription is able to parse "%s"', str_replace("\n", '\n', $test)));
        }
    }
}

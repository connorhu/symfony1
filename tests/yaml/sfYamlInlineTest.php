...
class sfYamlInlineTest extends TestCase
{
    ...
    public function testTodoMigrate()
    {
        ...
        foreach ($testsForLoad as $yaml => $value) {
            $this->is_deeply(sfYamlInline::load($yaml), $value, sprintf('::load() converts an inline YAML to a PHP structure (%s)', $yaml));
        }
        ...
        foreach ($testsForDump as $yaml => $value) {
            ...
            $this->is(sfYamlInline::dump($value), $yaml, sprintf('::dump() converts a PHP structure to an inline YAML (%s)', $yaml));
        }
        ...
        foreach ($testsForLoad as $yaml => $value) {
            ...
            $this->is_deeply(sfYamlInline::load(sfYamlInline::dump($value)), $value, 'check consistency');
        }

 ...
 * @version SVN: $Id$
 */
abstract class ModelGeneratorHelper
{
    public abstract function getUrlForAction($action);
...
class_alias(ModelGeneratorHelper::class, 'sfModelGeneratorHelper', false);
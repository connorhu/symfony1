 ...
 * @version SVN: $Id$
 */
class ModelGeneratorConfigurationField
{
    protected $name;
    protected $config;
    /**
    ...
    public function getConfig($key = null, $default = null, $escaped = false)
    {
        ...
        $value = ModelGeneratorConfiguration::getFieldConfigValue($this->config, $key, $default);
...
class_alias(ModelGeneratorConfigurationField::class, 'sfModelGeneratorConfigurationField', false);
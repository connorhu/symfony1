...
class FormField
{
    ...
    protected $value;
    /**
     * @var (ValidatorError | ValidatorErrorSchema | null)
     */
    protected $error;
    /**
     * Constructor.
     *
     * @param WidgetForm $widget A sfWidget instance
     ...
     */
    public function __construct(WidgetForm $widget, FormField $parent = null, $name, $value, ValidatorError $error = null)
    {
        $this->widget = $widget;
        $this->parent = $parent;
        $this->name = $name;
    ...
    */
    public function renderRow($attributes = array(), $label = null, $help = null)
    {
        ...
        $error = $this->error instanceof ValidatorErrorSchema ? $this->error->getGlobalErrors() : $this->error;
    ...
    public function renderError()
    {
        ...
        $error = $this->getWidget() instanceof WidgetFormSchema ? $this->getWidget()->getGlobalErrors($this->error) : $this->error;
     ...
     *
     * @return (Widget | WidgetFormSchemaDecorator) A sfWidget instance
     */
     ...
     *
     * @return FormField A sfFormField instance
     */
     ...
     *
     * @return ValidatorError A sfValidatorError instance
     */
    ...
    {
        if ($this->error instanceof ValidatorErrorSchema) {
            return $this->error->count() > 0;
        }
        return null !== $this->error;
    }
}
class_alias(FormField::class, 'sfFormField', false);
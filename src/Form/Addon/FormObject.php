 ...
 * @version SVN: $Id$
 */
abstract class FormObject extends BaseForm
{
     ...
     */
    public abstract function processValues($values);
    /**
...
class_alias(FormObject::class, 'sfFormObject', false);
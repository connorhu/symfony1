...
class Inflector
{
    ...
    */
    ...
    public static function underscore($camel_cased_word)
    {
        ...
        $tmp = str_replace('::', '/', $tmp);
        $tmp = Toolkit::pregtr($tmp, array('/([A-Z]+)([A-Z][a-z])/' => '\\1_\\2', '/([a-z\\d])([A-Z])/' => '\\1_\\2'));
    ...
    */
    ...
    {
        return Inflector::underscore(Inflector::demodulize($class_name)) . ($separate_with_underscore ? '_id' : 'id');
    }
    /**
    ...
    {
        return Inflector::camelize($table_name);
    }
    /**
...
class_alias(Inflector::class, 'sfInflector', false);
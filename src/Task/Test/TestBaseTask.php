 ...
 * @version SVN: $Id$
 */
abstract class TestBaseTask extends BaseTask
{
    /**
    ...
    {
        $event = new Event($this, 'task.test.filter_test_files', array('arguments' => $arguments, 'options' => $options));
    ...
    */
    ...
    {
        try {
            ApplicationConfiguration::getActive()->getPluginConfiguration($plugin);
            return true;
        } catch (Exception $e) {
            return false;
        }
...
class_alias(TestBaseTask::class, 'sfTestBaseTask', false);
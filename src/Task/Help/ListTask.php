 ...
 * @version SVN: $Id$
 */
class ListTask extends CommandApplicationTask
{
    /**
     * @see sfTask
     */
    ...
    {
        $this->addArguments(array(new CommandArgument('namespace', CommandArgument::OPTIONAL, 'The namespace name')));
...
class_alias(ListTask::class, 'sfListTask', false);
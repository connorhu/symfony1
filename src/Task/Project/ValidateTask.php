 ...
 * @version SVN: $Id$
 */
class ValidateTask extends BaseTask
{
    /**
     * @see sfTask
     */
...
EOF;
    ...
    {
        return str_replace(realpath(Config::get('sf_root_dir')), 'ROOT', realpath($file));
    }
...
class_alias(ValidateTask::class, 'sfValidateTask', false);
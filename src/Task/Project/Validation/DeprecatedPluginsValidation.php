 ...
 * @version SVN: $Id$
 */
class DeprecatedPluginsValidation extends Validation
{
    ...
    {
        return array('', '  The files above use deprecated plugins', '  that have been removed in symfony 1.4.', '', 'You can probably remove those references safely.', '');
    }
    public function validate()
    {
        $found = array();
        $files = Finder::type('file')->name('*Configuration.class.php')->in($this->getProjectConfigDirectories());
...
class_alias(DeprecatedPluginsValidation::class, 'sfDeprecatedPluginsValidation', false);
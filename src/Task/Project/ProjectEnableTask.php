...
use Symfony1\Components\Task\Cache\CacheClearTask;
use function count;
 ...
 * @version SVN: $Id$
 */
class ProjectEnableTask extends BaseTask
{
    /**
     * @see sfTask
     */
    ...
    protected function execute($arguments = array(), $options = array())
    {
        ...
        foreach ($applications as $app) {
            ...
            if (!file_exists($lockFile)) {
                ...
                $clearCache = new CacheClearTask($this->dispatcher, $this->formatter);
...
class_alias(ProjectEnableTask::class, 'sfProjectEnableTask', false);
 ...
 * @version SVN: $Id$
 */
class ProjectClearControllersTask extends BaseTask
{
    /**
     * @see sfTask
     */
...
EOF;
    ...
    {
        $finder = Finder::type('file')->maxdepth(1)->name('*.php');
        foreach ($finder->in(Config::get('sf_web_dir')) as $controller) {
...
class_alias(ProjectClearControllersTask::class, 'sfProjectClearControllersTask', false);
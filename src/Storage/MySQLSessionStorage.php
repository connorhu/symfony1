...
use function mysql_query;
use function mysql_real_escape_string;
use function mysql_num_rows;
use function mysql_fetch_row;
use function mysql_error;
/*
 ...
 * @version SVN: $Id$
 */
class MySQLSessionStorage extends DatabaseSessionStorage
{
    /**
     * Destroys a session.
     *
    ...
    public function sessionDestroy($id)
    {
        ...
        throw new DatabaseException(sprintf('%s cannot destroy session id "%s" (%s).', get_class($this), $id, $this->db_error()));
    }
    /**
    ...
    public function sessionGC($lifetime)
    {
        ...
        if (!$this->db_query($sql)) {
            throw new DatabaseException(sprintf('%s cannot delete old sessions (%s).', get_class($this), $this->db_error()));
        }
        return true;
    }
    /**
    ...
    public function sessionRead($id)
    {
        ...
        // can't create record
        throw new DatabaseException(sprintf('%s cannot create new record for id "%s" (%s).', get_class($this), $id, $this->db_error()));
    }
    /**
     * Writes session data.
     *
    ...
    public function sessionWrite($id, $data)
    {
        ...
        throw new DatabaseException(sprintf('%s cannot write session data for id "%s" (%s).', get_class($this), $id, $this->db_error()));
    }
    /**
...
class_alias(MySQLSessionStorage::class, 'sfMySQLSessionStorage', false);
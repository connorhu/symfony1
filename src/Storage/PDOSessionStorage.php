 ...
 * @version SVN: $Id$
 */
class PDOSessionStorage extends DatabaseSessionStorage
{
    /**
     * Destroys a session.
     *
    ...
    public function sessionDestroy($id)
    {
        ...
        try {
            ...
            throw new DatabaseException(sprintf('PDOException was thrown when trying to manipulate session data. Message: %s', $e->getMessage()));
        }
        return true;
    }
    /**
...
class_alias(PDOSessionStorage::class, 'sfPDOSessionStorage', false);
 ...
 * @version SVN: $Id$
 */
class PostgreSQLSessionStorage extends DatabaseSessionStorage
{
    /**
     * Destroys a session.
     *
    ...
    public function sessionDestroy($id)
    {
        ...
        throw new DatabaseException(sprintf('sfPostgreSQLSessionStorage cannot destroy session id "%s".', $id));
    }
    /**
    ...
    public function sessionGC($lifetime)
    {
        ...
        if (!@pg_query($this->db, $sql)) {
            throw new DatabaseException('sfPostgreSQLSessionStorage cannot delete old sessions.');
        }
        return true;
    }
    /**
    ...
    public function sessionRead($id)
    {
        ...
        // can't create record
        throw new DatabaseException(sprintf('sfPostgreSQLSessionStorage cannot create new record for id "%s".', $id));
    }
    /**
     * Writes session data.
     *
    ...
    public function sessionWrite($id, $data)
    {
        ...
        throw new DatabaseException(sprintf('sfPostgreSQLSessionStorage cannot write session data for id "%s".', $id));
    }
}
class_alias(PostgreSQLSessionStorage::class, 'sfPostgreSQLSessionStorage', false);
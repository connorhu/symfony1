...
* @version SVN: $Id$
*/
class OutputEscaperIteratorDecorator extends OutputEscaperObjectDecorator implements Iterator, ArrayAccess
{
    /**
    ...
    {
        return OutputEscaper::escape($this->escapingMethod, $this->iterator->current());
    }
    /**
    ...
    */
    ...
    {
        return OutputEscaper::escape($this->escapingMethod, $this->value[$offset]);
    }
    /**
...
class_alias(OutputEscaperIteratorDecorator::class, 'sfOutputEscaperIteratorDecorator', false);
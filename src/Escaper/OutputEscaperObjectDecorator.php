...
class OutputEscaperObjectDecorator extends OutputEscaperGetterDecorator implements Countable
{
    ...
    */
    public function __call($method, $args)
    {
        ...
        return OutputEscaper::escape($escapingMethod, $value);
    }
    /**
    ...
    *
    * @throws Exception if the object does not have a callable get() method
    */
    public function getRaw($key)
    {
        if (!is_callable(array($this->value, 'get'))) {
            throw new Exception('Object does not have a callable get() method.');
        }
...
class_alias(OutputEscaperObjectDecorator::class, 'sfOutputEscaperObjectDecorator', false);
 ...
 * @version SVN: $Id$
 */
class OutputEscaperArrayDecorator extends OutputEscaperGetterDecorator implements Iterator, ArrayAccess, Countable
{
    /**
    ...
    */
    ...
    {
        return OutputEscaper::escape($this->escapingMethod, current($this->value));
    }
    /**
    ...
    */
    ...
    public function offsetGet($offset)
    {
        ...
        return OutputEscaper::escape($this->escapingMethod, $value);
    }
    /**
...
class_alias(OutputEscaperArrayDecorator::class, 'sfOutputEscaperArrayDecorator', false);
...
class DateFormat
{
     ...
     * @var array
     */
    protected $tokens = array('G' => 'Era', 'y' => 'year', 'M' => 'mon', 'd' => 'mday', 'h' => 'Hour12', 'H' => 'hours', 'm' => 'minutes', 's' => 'seconds', 'E' => 'wday', 'D' => 'yday', 'F' => 'DayInMonth', 'w' => 'WeekInYear', 'W' => 'WeekInMonth', 'a' => 'AMPM', 'k' => 'HourInDay', 'K' => 'HourInAMPM', 'z' => 'TimeZone');
    /**
        ...
        if (!isset($date)) {
            if ($isString) {
                ...
                if (false === $numericalTime) {
                    throw new Exception(sprintf('Impossible to parse date "%s" with format "%s".', $time, $pattern));
                }
            } else {
                $numericalTime = $time;
            }
    ...
    public function format($time, $pattern = 'F', $inputPattern = null, $charset = 'UTF-8')
    {
        ...
        return Toolkit::I18N_toEncoding(implode('', $tokens), $charset);
    }
    /**
    ...
    protected function getYear($date, $pattern = 'yyyy')
    {
        ...
        switch ($pattern) {
            ...
            case 'yyyy':
                return $year;
            default:
                throw new Exception('The pattern for year is either "y", "yy", "yyy" or "yyyy".');
        }
    }
    /**
    * Gets the month.
    ...
    */
    protected function getMon($date, $pattern = 'M')
    {
        ...
        switch ($pattern) {
            ...
            default:
                throw new Exception('The pattern for month is "M", "MM", "MMM", "MMMM", "MMMMM".');
        }
    }
    /**
    ...
    */
    protected function getMday($date, $pattern = 'd')
    {
        ...
        switch ($pattern) {
            ...
            default:
                throw new Exception('The pattern for day of the month is "d", "dd" or "dddd".');
        }
    }
    /**
    ...
    */
    ...
    protected function getTimeZone($date, $pattern = 'z')
    {
        ...
        switch ($pattern) {
            ...
            // no break
            default:
                throw new Exception('The pattern for time zone is "z" or "Z".');
        }
...
class_alias(DateFormat::class, 'sfDateFormat', false);
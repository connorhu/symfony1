...
class NumberFormatInfo
{
    ...
    */
     ...
     *
     * @return NumberFormatInfo default sfNumberFormatInfo
     */
    ...
    *
    * @param CultureInfo $culture the culture that gets the sfNumberFormat property
    * @param int $type the number formatting type, it should be
    sfNumberFormatInfo::DECIMAL, sfNumberFormatInfo::CURRENCY,
    sfNumberFormatInfo::PERCENTAGE, or sfNumberFormatInfo::SCIENTIFIC
    *
    * @return NumberFormatInfo sfNumberFormatInfo for the specified culture
    *
    ...
    */
    public static function getInstance($culture = null, $type = NumberFormatInfo::DECIMAL)
    {
        ...
        if (is_string($culture)) {
            $sfCultureInfo = CultureInfo::getInstance($culture);
            $formatInfo = $sfCultureInfo->getNumberFormat();
            $formatInfo->setPattern($type);
            return $formatInfo;
        }
        $sfCultureInfo = CultureInfo::getInstance();
        $formatInfo = $sfCultureInfo->getNumberFormat();
        $formatInfo->setPattern($type);
        return $formatInfo;
    }
     ...
     *
     * @param CultureInfo $culture the culture that gets the NumberFormat property
     *
     * @return NumberFormatInfo sfNumberFormatInfo for the specified culture
     */
...
class_alias(NumberFormatInfo::class, 'sfNumberFormatInfo', false);
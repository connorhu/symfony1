...
use MessageSource as MessageSource1;
...
class MessageFormat
{
    ...
    *
    * @param MessageSource $source the source of translation messages
    ...
    */
    public function format($string, $args = array(), $catalogue = null, $charset = null)
    {
        ...
        $s = $this->formatString(Toolkit::I18N_toUTF8($string, $charset), $args, $catalogue);
        return Toolkit::I18N_toEncoding($s, $charset);
    }
    /**
...
class_alias(MessageFormat::class, 'sfMessageFormat', false);
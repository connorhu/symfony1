...
use function sqlite_open;
use function sqlite_query;
use function sqlite_fetch_array;
use function sqlite_close;
use function sqlite_fetch_single;
use function count;
use function time;
use function sqlite_changes;
use function explode;
use function sqlite_num_rows;
use const SQLITE_NUM;
/**
...
*/
class MessageSource_SQLite extends MessageSource_Database
{
    /**
...
class_alias(MessageSource_SQLite::class, 'sfMessageSource_SQLite', false);
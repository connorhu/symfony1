 ...
 * @version SVN: $Id$
 */
class MessageSource_Aggregate extends MessageSource
{
    ...
    */
    ...
    {
        throw new Exception('The "catalogues()" method is not implemented for this message source.');
    }
    /**
...
class_alias(MessageSource_Aggregate::class, 'sfMessageSource_Aggregate', false);
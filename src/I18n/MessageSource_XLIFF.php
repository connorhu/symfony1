...
*/
class MessageSource_XLIFF extends MessageSource_File
{
    /**
    ...
    */
    public function save($catalogue = 'messages')
    {
        ...
        if (false == is_writable($filename)) {
            throw new Exception(sprintf('Unable to save to file %s, file must be writable.', $filename));
        }
    ...
    public function update($text, $target, $comments, $catalogue = 'messages')
    {
        ...
        if (false == is_writable($filename)) {
            throw new Exception(sprintf('Unable to update file %s, file must be writable.', $filename));
        }
        // create a new dom, import the existing xml
        $dom = $this->createDOMDocument();
        $dom->load($filename);
    ...
    public function delete($message, $catalogue = 'messages')
    {
        ...
        if (false == is_writable($filename)) {
            throw new Exception(sprintf('Unable to modify file %s, file must be writable.', $filename));
        }
        // create a new dom, import the existing xml
        $dom = $this->createDOMDocument();
        $dom->load($filename);
...
class_alias(MessageSource_XLIFF::class, 'sfMessageSource_XLIFF', false);
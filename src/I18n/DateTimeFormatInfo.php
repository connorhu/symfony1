...
class DateTimeFormatInfo
{
    ...
    */
    public function __get($name)
    {
        ...
        throw new Exception(sprintf('Property %s does not exists.', $name));
    }
    /**
    * Allows functions that begins with 'set' to be called directly
    ...
    */
    public function __set($name, $value)
    {
        ...
        if (in_array($setProperty, $this->properties)) {
            ...
            throw new Exception(sprintf('Property %s can not be set.', $name));
        }
    }
    /**
     * Gets the default sfDateTimeFormatInfo that is culture-independent (invariant).
     *
     * @return DateTimeFormatInfo default sfDateTimeFormatInfo
     */
    public static function getInvariantInfo()
    {
        static $invariant;
        if (null === $invariant) {
            $invariant = CultureInfo::getInvariantCulture()->DateTimeFormat;
        }
        return $invariant;
    }
    /**
    ...
    *
    * @param CultureInfo $culture the culture that gets the sfDateTimeFormat property
    *
    * @return DateTimeFormatInfo sfDateTimeFormatInfo for the specified
    culture
    */
    public static function getInstance($culture = null)
    {
        ...
        if (is_string($culture)) {
            return CultureInfo::getInstance($culture)->DateTimeFormat;
        }
        return CultureInfo::getInvariantCulture()->DateTimeFormat;
    }
    /**
...
class_alias(DateTimeFormatInfo::class, 'sfDateTimeFormatInfo', false);
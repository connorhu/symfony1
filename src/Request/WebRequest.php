...
namespace Symfony1\Components\Request;
...
class WebRequest extends Request
{
    ...
    * @see sfRequest
    */
    public function initialize(EventDispatcher $dispatcher, $parameters = array(), $attributes = array(), $options = array())
    {
        ...
        if (version_compare(PHP_VERSION, '5.4.0-dev', '<') && get_magic_quotes_gpc()) {
            $this->getParameters = Toolkit::stripslashesDeep($_GET);
        } else {
        ...
        if (version_compare(PHP_VERSION, '5.4.0-dev', '<') && get_magic_quotes_gpc()) {
            $this->postParameters = Toolkit::stripslashesDeep($postParameters);
        } else {
    ...
    */
    ...
    public function getHttpHeader($name, $prefix = 'http')
    {
        ...
        $pathArray = $this->getPathInfoArray();
        return isset($pathArray[$name]) ? Toolkit::stripslashesDeep($pathArray[$name]) : null;
    }
    /**
    ...
    public function getCookie($name, $defaultValue = null)
    {
        ...
        if (isset($_COOKIE[$name])) {
            if (version_compare(PHP_VERSION, '5.4.0-dev', '<') && get_magic_quotes_gpc()) {
                $retval = Toolkit::stripslashesDeep($_COOKIE[$name]);
            } else {
                $retval = $_COOKIE[$name];
            }
        }
    ...
    {
        $pathArray = $this->getPathInfoArray();
        return isset($pathArray['HTTPS']) && ('on' == strtolower($pathArray['HTTPS']) || 1 == $pathArray['HTTPS']) || $this->getOption('trust_proxy') && isset($pathArray['HTTP_SSL_HTTPS']) && ('on' == strtolower($pathArray['HTTP_SSL_HTTPS']) || 1 == $pathArray['HTTP_SSL_HTTPS']) || $this->getOption('trust_proxy') && $this->isForwardedSecure();
    }
    /**
    ...
    */
    ...
    public function getGetParameter($name, $default = null)
    {
        ...
        return Toolkit::getArrayValueForPath($this->getParameters, $name, $default);
    }
    /**
    ...
    public function getPostParameter($name, $default = null)
    {
        ...
        return Toolkit::getArrayValueForPath($this->postParameters, $name, $default);
    }
    /**
    ...
    public function getUrlParameter($name, $default = null)
    {
        ...
        return Toolkit::getArrayValueForPath($this->requestParameters, $name, $default);
    }
    /**
    ...
    */
    ...
    {
        return array('path_info' => $this->getPathInfo(), 'prefix' => $this->getPathInfoPrefix(), 'method' => $this->getMethod(), 'format' => $this->getRequestFormat(), 'host' => $this->getHost(), 'is_secure' => $this->isSecure(), 'request_uri' => $this->getUri());
    }
    /**
    ...
    {
        return $this->dispatcher->filter(new Event($this, 'request.filter_parameters', $this->getRequestContext()), array())->getReturnValue();
    }
    /**
...
class_alias(WebRequest::class, 'sfWebRequest', false);
...
abstract class Request implements ArrayAccess
{
     ...
     * @param array $options
     */
    public function __construct(EventDispatcher $dispatcher, $parameters = array(), $attributes = array(), $options = array())
    {
    ...
    {
        $event = $this->dispatcher->notifyUntil(new Event($this, 'request.method_not_found', array('method' => $method, 'arguments' => $arguments)));
    ...
    */
     ...
     *
     * @return ParameterHolder The attribute holder
     */
...
class_alias(Request::class, 'sfRequest', false);
...
class Autoload
{
     ...
     *
     * @return Autoload a sfAutoload implementation instance
     */
    ...
    public function reloadClasses($force = false)
    {
        ...
        if (!$configuration || !$configuration instanceof ApplicationConfiguration) {
            return false;
        }
    ...
    public function loadClass($class)
    {
        ...
        if (Context::hasInstance() && ($module = Context::getInstance()->getModuleName()) && isset($this->classes[$module . '/' . $class])) {
            try {
...
class_alias(Autoload::class, 'sfAutoload', false);
 ...
 */
class ServiceContainerLoaderArray extends ServiceContainerLoader
{
    ...
    protected function resolveServices($value)
    {
        if (is_array($value)) {
            ...
            $value = new ServiceReference(substr($value, 1));
        }
        return $value;
    }
}
class_alias(ServiceContainerLoaderArray::class, 'sfServiceContainerLoaderArray', false);
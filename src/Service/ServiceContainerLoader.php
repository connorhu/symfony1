 ...
 */
abstract class ServiceContainerLoader implements ServiceContainerLoaderInterface
{
    protected $container;
    /**
     * Constructor.
     *
     * @param ServiceContainerBuilder $container A sfServiceContainerBuilder instance
     */
    public function __construct(ServiceContainerBuilder $container = null)
    {
     ...
     * @param ServiceContainerBuilder $container A sfServiceContainerBuilder instance
     */
    public function setServiceContainer(ServiceContainerBuilder $container)
    {
        $this->container = $container;
    }
    /**
    ...
    */
    public abstract function doLoad($resource);
}
class_alias(ServiceContainerLoader::class, 'sfServiceContainerLoader', false);
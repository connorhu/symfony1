...
class ServiceContainerBuilder extends ServiceContainer
{
    ...
    *
    * @return ServiceDefinition A sfServiceDefinition instance
    */
     ...
     *
     * @param string $id The service identifier
     * @param ServiceDefinition $definition A sfServiceDefinition instance
     *
     ...
     *
     * @param ServiceDefinition $definition A service definition instance
     *
...
class_alias(ServiceContainerBuilder::class, 'sfServiceContainerBuilder', false);
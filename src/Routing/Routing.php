...
abstract class Routing
{
     ...
     * @param array $options
     */
    public function __construct(EventDispatcher $dispatcher, Cache $cache = null, $options = array())
    {
     ...
     *
     * @return Cache A sfCache instance or null
     */
    ...
    */
    ...
    {
        $this->dispatcher->notify(new Event($this, 'routing.load_configuration'));
    }
    /**
    ...
    */
    public abstract function getCurrentInternalUri($with_route_name = false);
    /**
     ...
     * @return Route
     */
    public abstract function getRoute($name);
    /**
     ...
     * @return bool
     */
    public abstract function hasRoutes();
    /**
     * Clears all current routes.
     */
    public abstract function clearRoutes();
    /**
     ...
     */
    public abstract function generate($name, $params = array(), $absolute = false);
    /**
     ...
     */
    public function filterParametersEvent(Event $event, $parameters)
    {
...
class_alias(Routing::class, 'sfRouting', false);
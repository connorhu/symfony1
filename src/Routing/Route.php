...
class Route implements Serializable
{
    ...
    */
    ...
    {
        $this->options = array_merge(array('suffix' => '', 'variable_prefixes' => array(':'), 'segment_separators' => array('/', '.'), 'variable_regex' => '[\\w\\d_]+', 'text_regex' => '.+?', 'generate_shortest_url' => true, 'extra_parameters_as_query_string' => true), $this->getDefaultOptions(), $this->options);
        ...
        if (count($this->options['segment_separators'])) {
            ...
            $this->options['variable_content_regex'] = '[^' . implode('', array_map(version_compare(PHP_VERSION, '5.3.0RC4', '>=') ? $preg_quote_hash : $preg_quote_hash_53, $this->options['segment_separators'])) . ']+';
        } else {
...
class_alias(Route::class, 'sfRoute', false);
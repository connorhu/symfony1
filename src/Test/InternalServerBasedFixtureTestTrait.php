 ...
 * @coversNothing
 */
trait InternalServerBasedFixtureTestTrait
{
    private static $server;
    public static function setUpBeforeClass() : void
    {
        $descriptorPipes = array(1 => array('file', '/dev/null', 'w'), 2 => array('file', '/dev/null', 'w'));
...
class_alias(InternalServerBasedFixtureTestTrait::class, 'sfInternalServerBasedFixtureTestTrait', false);
 ...
 * @version SVN: $Id$
 */
class TestFunctional extends TestFunctionalBase
{
    /**
     ...
     *
     * @return TestFunctional The current sfTestFunctional instance
     */
...
class_alias(TestFunctional::class, 'sfTestFunctional', false);
...
use Symfony1\Components\Util\Browser;
use lime_test;
...
* @version SVN: $Id$
*/
class TestBrowser extends TestFunctional
{
    /**
    ...
    public function __construct($hostname = null, $remote = null, $options = array())
    {
        if (is_object($hostname)) {
            ...
            $browser = new Browser($hostname, $remote, $options);
            if (null === self::$test) {
...
class_alias(TestBrowser::class, 'sfTestBrowser', false);
...
abstract class Logger implements LoggerInterface
{
     ...
     *
     * @throws Exception if the priority level does not exist
     */
    public static function getPriorityName($priority)
    {
        static $levels = array(self::EMERG => 'emerg', self::ALERT => 'alert', self::CRIT => 'crit', self::ERR => 'err', self::WARNING => 'warning', self::NOTICE => 'notice', self::INFO => 'info', self::DEBUG => 'debug');
        if (!isset($levels[$priority])) {
            throw new Exception(sprintf('The priority level "%s" does not exist.', $priority));
        }
...
class_alias(Logger::class, 'sfLogger', false);
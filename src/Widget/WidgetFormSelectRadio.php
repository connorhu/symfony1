 ...
 * @version SVN: $Id$
 */
class WidgetFormSelectRadio extends WidgetFormChoiceBase
{
    /**
     * Renders the widget.
     *
    ...
    */
    ...
    protected function formatChoices($name, $value, $choices, $attributes)
    {
        $inputs = array();
        foreach ($choices as $key => $option) {
            $baseAttributes = array('name' => substr($name, 0, -2), 'type' => 'radio', 'value' => self::escapeOnce($key), 'id' => $id = $this->generateId($name, self::escapeOnce($key)));
...
class_alias(WidgetFormSelectRadio::class, 'sfWidgetFormSelectRadio', false);
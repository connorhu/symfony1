 ...
 * @version SVN: $Id$
 */
class WidgetFormFilterInput extends WidgetForm
{
    /**
     * Renders the widget.
     *
...
class_alias(WidgetFormFilterInput::class, 'sfWidgetFormFilterInput', false);
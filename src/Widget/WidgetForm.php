 ...
 * @version SVN: $Id$
 */
abstract class WidgetForm extends Widget
{
    protected $parent;
    /**
    * Constructor.
    ...
    */
     ...
     *
     * @return WidgetForm The current widget instance
     */
    public function setParent(WidgetFormSchema $widgetSchema = null)
    {
...
class_alias(WidgetForm::class, 'sfWidgetForm', false);
 ...
 * @version SVN: $Id$
 */
class WidgetFormI18nChoiceTimezone extends WidgetFormChoice
{
    /**
    * Constructor.
    *
    ...
    */
    protected function configure($options = array(), $attributes = array())
    {
        ...
        $timezones = array_keys(CultureInfo::getInstance($culture)->getTimeZones());
...
class_alias(WidgetFormI18nChoiceTimezone::class, 'sfWidgetFormI18nChoiceTimezone', false);
 ...
 * @version SVN: $Id$
 */
class WidgetFormI18nChoiceCountry extends WidgetFormChoice
{
    /**
    * Constructor.
    *
    ...
    */
    protected function configure($options = array(), $attributes = array())
    {
        ...
        $countries = CultureInfo::getInstance($culture)->getCountries(isset($options['countries']) ? $options['countries'] : null);
...
class_alias(WidgetFormI18nChoiceCountry::class, 'sfWidgetFormI18nChoiceCountry', false);
 ...
 * @version SVN: $Id$
 */
class WidgetFormI18nChoiceCurrency extends WidgetFormChoice
{
    /**
    * Constructor.
    *
    ...
    */
    protected function configure($options = array(), $attributes = array())
    {
        ...
        $currencies = CultureInfo::getInstance($culture)->getCurrencies(isset($options['currencies']) ? $options['currencies'] : null);
...
class_alias(WidgetFormI18nChoiceCurrency::class, 'sfWidgetFormI18nChoiceCurrency', false);
 ...
 * @version SVN: $Id$
 */
class WidgetFormDateRange extends WidgetForm
{
    /**
     * Renders the widget.
     *
    ...
    public function render($name, $value = null, $attributes = array(), $errors = array())
    {
        ...
        return strtr($this->translate($this->getOption('template')), array('%from_date%' => $this->getOption('from_date')->render($name . '[from]', $value['from'], $attributes['from'], $errors), '%to_date%' => $this->getOption('to_date')->render($name . '[to]', $value['to'], $attributes['to'], $errors)));
    }
    /**
...
class_alias(WidgetFormDateRange::class, 'sfWidgetFormDateRange', false);
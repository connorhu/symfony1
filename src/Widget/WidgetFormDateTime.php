 ...
 * @version SVN: $Id$
 */
class WidgetFormDateTime extends WidgetForm
{
    /**
     * Renders the widget.
     *
    ...
    public function render($name, $value = null, $attributes = array(), $errors = array())
    {
        ...
        return strtr($this->getOption('format'), array('%date%' => $date, '%time%' => $this->getTimeWidget($attributes)->render($name, $value)));
    }
    /**
    ...
    */
     ...
     *
     * @return WidgetForm A Widget representing the date
     */
    protected function getDateWidget($attributes = array())
    {
        return new WidgetFormDate($this->getOptionsFor('date'), $this->getAttributesFor('date', $attributes));
    }
    /**
     ...
     * @param array $attributes An array of attributes
     *
     * @return WidgetForm A Widget representing the time
     */
    protected function getTimeWidget($attributes = array())
    {
        return new WidgetFormTime($this->getOptionsFor('time'), $this->getAttributesFor('time', $attributes));
    }
    /**
...
class_alias(WidgetFormDateTime::class, 'sfWidgetFormDateTime', false);
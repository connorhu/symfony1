 ...
 * @version SVN: $Id$
 */
class WidgetFormSchemaDecorator extends WidgetFormSchema
{
    protected $widget;
    protected $decorator = '';
    /**
     * Constructor.
     *
     * @param WidgetFormSchema $widget A sfWidgetFormSchema instance
     * @param string $decorator A decorator string
     *
     * @see sfWidgetFormSchema
     */
    public function __construct(WidgetFormSchema $widget, $decorator)
    {
        $this->widget = $widget;
     ...
     *
     * @return Widget The decorated widget
     */
     ...
     * @see sfWidgetFormSchema
     */
    public function setParent(WidgetFormSchema $parent = null)
    {
...
class_alias(WidgetFormSchemaDecorator::class, 'sfWidgetFormSchemaDecorator', false);
    ...
    */
    public function initialize($options = array())
    {
        ...
        if (!class_exists('Memcache')) {
            throw new InitializationException('You must have memcache installed and enabled to use sfMemcacheCache class.');
        }
...
class_alias(MemcacheCache::class, 'sfMemcacheCache', false);
...
class MySQLDatabase extends Database
{
    ...
    public function connect()
    {
        ...
        if (false === $this->connection) {
            ...
            throw new DatabaseException('Failed to create a MySQLDatabase connection.');
        }
        // select our database
        if ($this->selectDatabase($database)) {
            // can't select the database
            throw new DatabaseException(sprintf('Failed to select MySQLDatabase "%s".', $database));
        }
...
class_alias(MySQLDatabase::class, 'sfMySQLDatabase', false);
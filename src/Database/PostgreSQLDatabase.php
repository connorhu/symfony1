...
class PostgreSQLDatabase extends Database
{
    ...
    public function connect()
    {
        ...
        $string = (null != $database ? ' dbname=' . $database : '') . (null != $host ? ' host=' . $host : '') . (null != $password ? ' password=' . $password : '') . (null != $port ? ' port=' . $port : '') . (null != $username ? ' user=' . $username : '');
        ...
        if (false === $this->connection) {
            ...
            throw new DatabaseException('Failed to create a PostgreSQLDatabase connection.');
        }
...
class_alias(PostgreSQLDatabase::class, 'sfPostgreSQLDatabase', false);
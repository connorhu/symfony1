 ...
 * @version SVN: $Id$
 */
class WebDebugPanelTimer extends WebDebugPanel
{
    ...
    public function filterLogs(Event $event, $logs)
    {
        $newLogs = array();
        foreach ($logs as $log) {
...
class_alias(WebDebugPanelTimer::class, 'sfWebDebugPanelTimer', false);
 ...
 * @version SVN: $Id$
 */
class ValidatorSchema extends ValidatorBase implements ArrayAccess
{
    ...
    */
     ...
     *
     * @param ValidatorBase $validator An sfValidatorBase instance
     *
     * @return ValidatorBase The current validator instance
     */
    public function setPreValidator(ValidatorBase $validator)
    {
     ...
     *
     * @return ValidatorBase A sfValidatorBase instance
     */
     ...
     * @return ValidatorBase The current validator instance
     */
    public function setPostValidator(ValidatorBase $validator)
    {
     ...
     *
     * @return ValidatorBase An sfValidatorBase instance
     */
     ...
     * @param string $name The field name
     *
     * @return ValidatorBase The sfValidatorBase instance associated with the given name, null if it does not exist
     */
    #[ReturnTypeWillChange]
     ...
     *
     * @return ValidatorBase[] An array of sfValidatorBase instances
     */
    ...
    */
        ...
        foreach ($values as $name => $value) {
            ...
            if (!array_key_exists($name, $this->fields)) {
                if (!$this->options['allow_extra_fields']) {
                    $errorSchema->addError(new ValidatorError($this, 'extra_fields', array('field' => $name)));
    ...
    protected function getBytes($value)
    {
        ...
        $exp_by_modifier = array('k' => 1, 'm' => 2, 'g' => 3);
...
class_alias(ValidatorSchema::class, 'sfValidatorSchema', false);
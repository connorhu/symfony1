 ...
 * @version SVN: $Id$
 */
abstract class ValidatorDecorator extends ValidatorBase
{
    protected $validator;
    /**
     * @see sfValidatorBase
    ...
    public function __construct($options = array(), $messages = array())
    {
        ...
        if (!$this->validator instanceof ValidatorBase) {
...
class_alias(ValidatorDecorator::class, 'sfValidatorDecorator', false);
...
abstract class ValidatorBase
{
    ...
    */
     ...
     */
    public final function getErrorCodes()
    {
    ...
    public function asString($indent = 0)
    {
        ...
        return sprintf('%s%s(%s%s)', str_repeat(' ', $indent), str_replace('sfValidator', '', get_class($this)), $options ? YamlInline::dump($options) : ($messages ? '{}' : ''), $messages ? ', ' . YamlInline::dump($messages) : '');
    }
    /**
    ...
    */
     ...
     * @throws ValidatorError
     */
    protected abstract function doClean($value);
    /**
...
class_alias(ValidatorBase::class, 'sfValidatorBase', false);
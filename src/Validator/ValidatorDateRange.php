 ...
 * @version SVN: $Id$
 */
class ValidatorDateRange extends ValidatorBase
{
    /**
    ...
    */
    ...
    protected function doClean($value)
    {
        ...
        if ($value[$fromField] && $value[$toField]) {
            $v = new ValidatorSchemaCompare($fromField, ValidatorSchemaCompare::LESS_THAN_EQUAL, $toField, array('throw_global_error' => true), array('invalid' => $this->getMessage('invalid')));
            $v->clean($value);
        }
        return $value;
    }
}
class_alias(ValidatorDateRange::class, 'sfValidatorDateRange', false);
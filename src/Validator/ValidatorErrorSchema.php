...
class ValidatorErrorSchema extends ValidatorError implements ArrayAccess, Iterator, Countable
{
     ...
     */
    public function __construct(ValidatorBase $validator, $errors = array())
    {
     ...
     *
     * @param ValidatorError $error An sfValidatorError instance
    ...
    public function addError(ValidatorError $error, $name = null)
    {
        if (null === $name) {
            ...
            if (!$this->namedErrors[$name] instanceof ValidatorErrorSchema) {
     ...
     * @return ValidatorErrorSchema The current error schema instance
     */
    public function addErrors(ValidatorErrorSchema $errors)
    {
     ...
     *
     * @return ValidatorError[] An array of sfValidatorError instances
     */
    ...
    {
        $this->code = implode(' ', array_merge(array_map(function ($e) {
            /* @var $e sfValidatorError */
            return $e->getCode();
        }, $this->globalErrors), array_map(function ($n, $e) {
            /* @var $e sfValidatorError */
            return $n . ' [' . $e->getCode() . ']';
    ...
    {
        $this->message = implode(' ', array_merge(array_map(function ($e) {
            /* @var $e sfValidatorError */
            return $e->getMessage();
        }, $this->globalErrors), array_map(function ($n, $e) {
            /* @var $e sfValidatorError */
...
class_alias(ValidatorErrorSchema::class, 'sfValidatorErrorSchema', false);
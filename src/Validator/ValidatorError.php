...
class ValidatorError extends Exception implements Serializable
{
     ...
     */
    public function __construct(ValidatorBase $validator, $code, $arguments = array())
    {
    ...
    public function getArguments($raw = false)
    {
        ...
        foreach ($this->arguments as $key => $value) {
            ...
            $arguments["%{$key}%"] = null !== $value ? htmlspecialchars($value, ENT_QUOTES, ValidatorBase::getCharset()) : '';
        }
        return $arguments;
    }
    /**
...
class_alias(ValidatorError::class, 'sfValidatorError', false);
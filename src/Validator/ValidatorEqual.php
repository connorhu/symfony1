 ...
 * @version SVN: $Id$
 */
class ValidatorEqual extends ValidatorBase
{
    /**
    ...
    */
    ...
    protected function doClean($value)
    {
        ...
        if ($isStrict && $value !== $this->getOption('value') || !$isStrict && $value != $this->getOption('value')) {
            throw new ValidatorError($this, $isStrict ? 'not_strictly_equal' : 'not_equal', array('value' => $value, 'compared_value' => $this->getOption('value')));
        }
        return $value;
    }
}
class_alias(ValidatorEqual::class, 'sfValidatorEqual', false);
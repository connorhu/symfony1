 ...
 * @version SVN: $Id$
 */
class PartialView extends PHPView
{
    protected $viewCache;
    ...
    public function render()
    {
        if (Config::get('sf_debug') && Config::get('sf_logging_enabled')) {
            $timer = TimerManager::getTimer(sprintf('Partial "%s/%s"', $this->moduleName, $this->actionName));
        }
...
class_alias(PartialView::class, 'sfPartialView', false);
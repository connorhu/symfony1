...
class CommandOptionSet
{
     ...
     *
     * @param CommandOption $option A sfCommandOption object
     *
    ...
    public function addOption(CommandOption $option)
    {
        if (isset($this->options[$option->getName()])) {
            throw new CommandException(sprintf('An option named "%s" already exist.', $option->getName()));
        }
        if (isset($this->shortcuts[$option->getShortcut()])) {
            throw new CommandException(sprintf('An option with shortcut "%s" already exist.', $option->getShortcut()));
        }
     ...
     *
     * @return CommandOption A sfCommandOption object
     *
     * @throws CommandException
     */
    ...
    protected function shortcutToName($shortcut)
    {
        if (!isset($this->shortcuts[$shortcut])) {
            throw new CommandException(sprintf('The "-%s" option does not exist.', $shortcut));
        }
        return $this->shortcuts[$shortcut];
    }
}
class_alias(CommandOptionSet::class, 'sfCommandOptionSet', false);
...
class CommandOption
{
    ...
    public function __construct($name, $shortcut = null, $mode = null, $help = '', $default = null)
    {
        ...
        if (null === $mode) {
            ...
            throw new CommandException(sprintf('Option mode "%s" is not valid.', $mode));
        }
        $this->name = $name;
    ...
    public function setDefault($default = null)
    {
        if (self::PARAMETER_NONE === (self::PARAMETER_NONE & $this->mode) && null !== $default) {
            throw new CommandException('Cannot set a default value when using sfCommandOption::PARAMETER_NONE mode.');
        }
        if ($this->isArray()) {
            if (null === $default) {
                $default = array();
            } elseif (!is_array($default)) {
                throw new CommandException('A default value for an array option must be an array.');
            }
        }
...
class_alias(CommandOption::class, 'sfCommandOption', false);
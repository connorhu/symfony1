...
class CommandArgumentSet
{
     ...
     *
     * @param CommandArgument $argument A sfCommandArgument object
     *
    ...
    public function addArgument(CommandArgument $argument)
    {
        if (isset($this->arguments[$argument->getName()])) {
            throw new CommandException(sprintf('An argument with name "%s" already exist.', $argument->getName()));
        }
        if ($this->hasAnArrayArgument) {
            throw new CommandException('Cannot add an argument after an array argument.');
        }
        if ($argument->isRequired() && $this->hasOptional) {
            throw new CommandException('Cannot add a required argument after an optional one.');
        }
        if ($argument->isArray()) {
     ...
     *
     * @return CommandArgument A sfCommandArgument object
     *
     * @throws CommandException
     */
...
class_alias(CommandArgumentSet::class, 'sfCommandArgumentSet', false);
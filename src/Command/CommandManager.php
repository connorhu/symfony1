...
class CommandManager
{
    ...
    /**
     * @var CommandOptionSet
     */
    protected $optionSet;
    /**
     * @var CommandArgumentSet
     */
     ...
     * Constructor.
     *
     * @param CommandArgumentSet $argumentSet A sfCommandArgumentSet object
     * @param CommandOptionSet $optionSet A setOptionSet object
     */
    public function __construct(CommandArgumentSet $argumentSet = null, CommandOptionSet $optionSet = null)
    {
        if (null === $argumentSet) {
            $argumentSet = new CommandArgumentSet();
        }
        $this->setArgumentSet($argumentSet);
        if (null === $optionSet) {
            $optionSet = new CommandOptionSet();
        }
     ...
     * @param CommandArgumentSet $argumentSet A sfCommandArgumentSet object
     */
    public function setArgumentSet(CommandArgumentSet $argumentSet)
    {
     ...
     *
     * @return CommandArgumentSet A sfCommandArgumentSet object
     */
     ...
     * Sets the option set.
     *
     * @param CommandOptionSet $optionSet A sfCommandOptionSet object
     */
    public function setOptionSet(CommandOptionSet $optionSet)
    {
     ...
     * Gets the option set.
     *
     * @return CommandOptionSet A sfCommandOptionSet object
     */
    ...
    public function getArgumentValue($name)
    {
        if (!$this->argumentSet->hasArgument($name)) {
            throw new CommandException(sprintf('The "%s" argument does not exist.', $name));
        }
    ...
    public function getOptionValue($name)
    {
        if (!$this->optionSet->hasOption($name)) {
            throw new CommandException(sprintf('The "%s" option does not exist.', $name));
        }
        return $this->optionValues[$name];
    }
    public function setOption(CommandOption $option, $value)
    {
        if ($option->isArray()) {
...
class_alias(CommandManager::class, 'sfCommandManager', false);
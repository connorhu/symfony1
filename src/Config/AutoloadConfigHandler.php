 ...
 * @version SVN: $Id$
 */
class AutoloadConfigHandler extends YamlConfigHandler
{
    /**
    ...
    public static function getConfiguration(array $configFiles)
    {
        ...
        $event = $configuration->getEventDispatcher()->filter(new Event(__CLASS__, 'autoload.filter_config'), $config);
    ...
    protected function parse(array $configFiles)
    {
        ...
        foreach ($config['autoload'] as $name => $entry) {
            ...
            if (isset($entry['files'])) {
                ...
                require_once Config::get('sf_symfony_lib_dir') . '/util/sfFinder.class.php';
                $finder = Finder::type('file')->name('*' . $ext)->follow_link();
                // recursive mapping?
...
class_alias(AutoloadConfigHandler::class, 'sfAutoloadConfigHandler', false);